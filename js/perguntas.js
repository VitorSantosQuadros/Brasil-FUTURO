        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "No início ficou com medo dessa realidade.",
                    "Ficou em pânico com tudo isso.",
                ],
                proxima: 1,
            },
            {
                ...
                afirmacao: [
                    "Quis saber como se juntava aos corruptos safados.",
                    "Você só se entregou ao crime mesmo...",
                ],
                proxima: 2,
            },
        ]
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "Conseguiu utilizar a internet e o network para buscar informações úteis.",
                    "Começa a utilizar os livros para conseguir a sabedoria e novas ideias sobre o mundo.",
                ],
                proxima: 3,
            },
            {
                ...
                afirmacao: [
                    "Sentiu mais facilidade em continuar na sua ignorância kkkkkkkkk.",
                    "Você preferiu ficar na sua sem pesquisar nada.",
                ],
                proxima: 4,
            },
        ]
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "Com bastante gente gostando dos meus conhecimentos que adquiri, isso vem me motivando ainda mais.",
                    "Percebeu que se continuar se esforçando você irá ser conhecido mundialmente.",
                ],
                proxima: 3,
            },
            {
                ...
                afirmacao: [
                    "Mesmo sua preocupação com as pessoas de saberem do seu trabalho você encontra forças para continuar.",
                    "O espirito da bravura entrou em você e a timidez logo passou.",
                ],
                proxima: 4,
            },
        ]
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "A população te ama, e você se sente realizado por ter ajudado tantas pessoas de uma só vez.",
                    "Todos te amam, você se sente o héroi deles."
                ],
                proxima: 5,
            },
            {
                ...
                afirmacao: [
                    "A população se sente traida e agradecida ao mesmo tempo, e você ganha tanto poder mas se sente tão triste e deprimido por ter no fundo traido o povo.",
                    "Você acaba se tornando o vilão da população brasileira."
                ],
                proxima: 6,
            },
        ]
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "Felizmente ganhamos a guerra .",
                    "A guerra durou 13 anos e no fim, depois de muito esforço nós finalmente ganhamos a batalha."
                ],
            },
            {
